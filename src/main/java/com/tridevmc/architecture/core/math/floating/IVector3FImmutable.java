...
/**
 * An extension of {@link IVector3F} that is expected to be immutable.
 * <p>
 * Construct using {@link IVector3FImmutable#of(float, float, float)}.
 * <p>
 * See also {@link IVector3F}, and {@link IVector3FMutable}.
 */
public interface IVector3FImmutable extends IVector3F {
     ...
     */
    static IVector3FImmutable of(float x, float y, float z) {
     ...
     * @return The new vector.
     */
    static IVector3FImmutable of(IVector3F vec) {
     ...
     * <p>
     * This method always returns a new instance, if you plan to make multiple modifications to a vector, it's recommended to use {@link IVector3F#asMutable()} instead.
     *
     ...
     * @return The new vector.
     */
    default IVector3FImmutable add(float x, float y, float z) {
     ...
     * @return The new vector.
     */
    default IVector3FImmutable add(IVector3F vec) {
     ...
     * @return The new vector.
     */
    default IVector3FImmutable sub(float x, float y, float z) {
        return of(this.x() - x, this.y() - y, this.z() - z);
    }
     ...
     * @return The new vector.
     */
    default IVector3FImmutable sub(IVector3F vec) {
     ...
     * @return The new vector.
     */
    default IVector3FImmutable mul(float x, float y, float z) {
        return of(this.x() * x, this.y() * y, this.z() * z);
    }
     ...
     * @return The new vector.
     */
    default IVector3FImmutable mul(IVector3F vec) {
     ...
     * @return The new vector.
     */
    default IVector3FImmutable mul(float value) {
     ...
     * @return The new vector.
     */
    default IVector3FImmutable div(float x, float y, float z) {
        return of(this.x() / x, this.y() / y, this.z() / z);
    }
     ...
     * @return The new vector.
     */
    default IVector3FImmutable div(IVector3F vec) {
     ...
     * @return The new vector.
     */
    default IVector3FImmutable div(float value) {
     ...
     * @return The new vector.
     */
    default IVector3FImmutable cross(float x, float y, float z) {
     ...
     * @return The new vector.
     */
    default IVector3FImmutable cross(IVector3F vec) {
     ...
     * @return The new vector.
     */
    default IVector3FImmutable min(float x, float y, float z) {
     ...
     * @return The new vector.
     */
    default IVector3FImmutable min(IVector3F vec) {
     ...
     * @return The new vector.
     */
    default IVector3FImmutable max(float x, float y, float z) {
     ...
     * @return The new vector.
     */
    default IVector3FImmutable max(IVector3F vec) {
