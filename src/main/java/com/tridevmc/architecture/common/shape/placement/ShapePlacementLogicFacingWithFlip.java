...
public class ShapePlacementLogicFacingWithFlip implements IShapePlacementLogic<BlockArchitecture> {

    public static final ShapePlacementLogicFacingWithFlip INSTANCE = new ShapePlacementLogicFacingWithFlip();
