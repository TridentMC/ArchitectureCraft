 ...
 */
public class ShapePlacementLogicPointedByNearestFacing implements IShapePlacementLogic<BlockArchitecture> {

    public static final ShapePlacementLogicPointedByNearestFacing INSTANCE = new ShapePlacementLogicPointedByNearestFacing();
